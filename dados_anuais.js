window.__DADOS_ANUAIS__ = {
  ...
  "pib_per_capita_ppp": {
    "label": "PIB per capita (PPP, US$ 2021)",
    "cor": "#0ea5e9",
    ...
    "como_interpretar":
      "Valores maiores indicam maior produção econômica real média por habitante, com ajuste para diferenças de custo de vida entre países. O indicador não mede distribuição de renda, desigualdade, informalidade ou bem-estar individual.",
    "metodologia":
    ...
    "historico_metodologia":
      "A série atual do WDI está expressa em dólares internacionais constantes de 2021 e incorpora os resultados do ciclo ICP 2021. Como em outras séries de contas nacionais e PPP, os valores podem ser revisados quando há atualização de contas nacionais, população, PPPs ou mudança de ano-base internacional. Não há dado observado para 2025 na fonte consultada; por isso a série validada vai somente até 2024.",
    "abrangencia":
    ...
    "fontes_links": [
      ...
      {
        "titulo": "UNdata / World Development Indicators - NY.GDP.PCAP.PP.KD - Brazil",
        "url": "https://data.un.org/Data.aspx?d=WDI&f=Indicator_Code%3ANY.GDP.PCAP.PP.KD%3BCountry_Code%3ABRA",
      },
      {
  ...
  "reservas_internacionais": {
    "label": "Reservas Internacionais (US$)",
    "cor": "#059669",
  ...
  "gap_eficiencia_br": {
    "label": "Ranking IRBES (Retorno Tributário em Bem-Estar)",
    "cor": "#94a3b8",
  ...
  "despesa_pessoal_rcl": {
    "label": "Despesa com Pessoal / RCL - Executivo Federal",
    "cor": "#db2777",
    "unidade": "%",
    "fonte": "Tesouro Nacional / Relatório de Gestão Fiscal (RGF)",
    "cat": "Economia",
    "descricao":
      "Percentual da Receita Corrente Líquida comprometido com a Despesa Total com Pessoal do Poder Executivo Federal, conforme metodologia da Lei de Responsabilidade Fiscal.",
    "como_interpretar":
      "Valores maiores indicam maior comprometimento da Receita Corrente Líquida com pessoal e menor margem fiscal. O limite máximo da LRF para o Poder Executivo Federal é 37,9% da RCL; acima desse limite há restrições legais. Valores abaixo do limite indicam cumprimento formal da LRF, mas não significam necessariamente folga orçamentária ampla.",
    "metodologia":
      "Despesa Total com Pessoal do Poder Executivo Federal dividida pela Receita Corrente Líquida ajustada para cálculo dos limites de despesa com pessoal, considerando os últimos 12 meses do quadrimestre de referência. A apuração segue os arts. 18 a 20 da Lei Complementar nº 101/2000, o Manual de Demonstrativos Fiscais da STN e o Relatório de Gestão Fiscal. Os valores anuais usam o 3º quadrimestre, equivalente ao fechamento de dezembro.",
    "historico_metodologia":
      "A série oficial comparável começa em dezembro de 2000, pois a LRF instituiu o Relatório de Gestão Fiscal e os limites de despesa com pessoal. Não há série oficial equivalente para 1994-1999. A metodologia segue a LRF, o MDF/STN e eventuais orientações de controle; por isso pode divergir de outros agregados de despesa de pessoal publicados em bases orçamentárias. A partir de 2020, mudanças legais e fiscais associadas à pandemia afetaram fortemente a RCL usada como denominador, especialmente no fechamento de 2020.",
    "abrangencia":
      "Poder Executivo Federal da União. Não inclui Legislativo, Judiciário, Ministério Público da União, Defensoria Pública da União, estados, Distrito Federal ou municípios. O limite usado é o do Executivo Federal: 37,9% da Receita Corrente Líquida.",
    "periodicidade":
      "Quadrimestral, com publicação do Relatório de Gestão Fiscal. Os dados apresentados usam apenas o 3º quadrimestre de cada ano.",
    "eventos_externos": [
      {
        "ano": 2000,
        "nome": "LRF",
        "descricao":
          "A Lei Complementar nº 101/2000 instituiu o Relatório de Gestão Fiscal e os limites de despesa com pessoal em percentual da Receita Corrente Líquida, criando a base metodológica oficial da série.",
      },
      {
        "ano": 2020,
        "nome": "Pandemia",
        "descricao":
          "A queda relevante da Receita Corrente Líquida em 2020 elevou fortemente a razão Despesa Total com Pessoal/RCL, mesmo sem aumento proporcional equivalente da despesa de pessoal.",
      },
      {
        "ano": 2021,
        "nome": "Recuperação RCL",
        "descricao":
          "A recomposição da Receita Corrente Líquida após o choque de 2020 reduziu o indicador no fechamento de 2021 para 21,8% da RCL.",
      },
      {
        "ano": 2022,
        "nome": "Alta da RCL",
        "descricao":
          "O indicador caiu para 18,9% da RCL em 2022, redução de 2,9 pontos percentuais frente a 2021, com RCL de R$ 1,253 trilhão no período analisado.",
      },
      {
        "ano": 2023,
        "nome": "Alta pessoal",
        "descricao": "O indicador subiu para 20,5% da RCL em 2023, aumento de 1,6 ponto percentual em relação a 2022.",
      },
      {
        "ano": 2024,
        "nome": "Expansão RCL",
        "descricao":
          "O indicador caiu para 18,2% da RCL em 2024, com despesa de pessoal de R$ 260 bilhões e RCL de R$ 1,430 trilhão.",
      },
      {
        "ano": 2025,
        "nome": "Nova alta",
        "descricao":
          "O indicador subiu para 18,7% da RCL em 2025, com despesa de pessoal de R$ 284 bilhões e RCL de R$ 1,517 trilhão.",
      },
    ],
    "comparacao_paises":
      "Não há comparação internacional direta confiável, porque Receita Corrente Líquida, limites da LRF e Relatório de Gestão Fiscal são conceitos legais brasileiros. Comparações com outros países exigiriam outra métrica, como despesa de compensação de empregados sobre receita ou despesa primária do governo central, o que não é metodologicamente equivalente.",
    "nivel_confiabilidade":
      "Alto para 2000-2025, desde que interpretado estritamente como indicador LRF/RGF do Poder Executivo Federal no 3º quadrimestre. Não há dados oficiais comparáveis para 1994-1999, portanto esses anos foram removidos.",
    "validacao": "GPT-5.5 Thinking (OpenAI) - 24/04/2026",
    "padrao": false,
    "fontes_links": [
      {
        "titulo": "Tesouro Transparente - Limites da LRF para a União: Despesas com Pessoal do Poder Executivo Federal",
        "url":
          "https://www.tesourotransparente.gov.br/ckan/dataset/limites-da-lrf-para-a-uniao-despesas-com-pessoal-do-poder-executivo-federal",
      },
      {
        "titulo":
          "Tesouro Transparente - CSV Histórico quadrimestral das Despesas com Pessoal do Poder Executivo Federal",
        "url":
          "https://www.tesourotransparente.gov.br/ckan/dataset/a49d6433-ab0b-41d2-bf79-4d16973831f3/resource/92580d1e-0e30-45c9-9aa1-7a05586a30da/download/limites-da-lrf-para-a-uniao---despesas-com-pessoal.csv",
      },
      {
        "titulo": "Tesouro Nacional - Despesa de pessoal do Poder Executivo Federal em 2022",
        "url":
          "https://www.gov.br/tesouronacional/pt-br/noticias/a-despesa-de-pessoal-do-poder-executivo-da-uniao-atinge-o-valor-de-18-9-da-receita-corrente-liquida-2013-rcl-em-2022",
      },
      {
        "titulo": "Tesouro Nacional - Despesa de pessoal do Poder Executivo Federal em 2023",
        "url":
          "https://www.gov.br/tesouronacional/pt-br/noticias/despesa-de-pessoal-do-poder-executivo-federal-atinge-20-5-da-receita-corrente-liquida-em-2023",
      },
      {
        "titulo": "Tesouro Nacional - Despesa de pessoal do Poder Executivo Federal em 2024",
        "url":
          "https://www.gov.br/tesouronacional/pt-br/noticias/despesa-de-pessoal-do-poder-executivo-federal-alcanca-r-260-bilhoes-no-3o-quadrimestre-de-2024",
      },
      {
        "titulo": "Tesouro Nacional - Despesa de pessoal do Poder Executivo Federal em 2025",
        "url":
          "https://www.gov.br/tesouronacional/pt-br/noticias/despesa-de-pessoal-do-poder-executivo-federal-alcanca-r-284-bilhoes-no-3o-quadrimestre-de-2025",
      },
      {
        "titulo": "Controladoria-Geral da União - RGF Poder Executivo Federal 3º quadrimestre de 2019",
        "url":
          "https://www.gov.br/cgu/pt-br/assuntos/noticias/2020/02/cgu-publica-relatorio-de-gestao-fiscal-do-terceiro-quadrimestre-de-2019/rgf3q2019.pdf",
      },
      {
        "titulo": "Controladoria-Geral da União - RGF Poder Executivo Federal 3º quadrimestre de 2020",
        "url":
          "https://www.gov.br/cgu/pt-br/assuntos/noticias/2021/02/cgu-publica-relatorio-de-gestao-fiscal-do-terceiro-quadrimestre-de-2020/rgf_3o-quadrimestre_2020.pdf",
      },
      {
    ...
    "dados": [
      { "ano": 2000, "valor": 32.3 },
      { "ano": 2001, "valor": 27.8 },
      { "ano": 2002, "valor": 25.18 },
      { "ano": 2003, "valor": 24.34 },
      { "ano": 2004, "valor": 22.65 },
      { "ano": 2005, "valor": 21.03 },
      { "ano": 2006, "valor": 21.45 },
      { "ano": 2007, "valor": 20.46 },
      { "ano": 2008, "valor": 21.87 },
      { "ano": 2009, "valor": 24.34 },
      { "ano": 2010, "valor": 24.22 },
      { "ano": 2011, "valor": 23.84 },
      { "ano": 2012, "valor": 21.68 },
      { "ano": 2013, "valor": 22.94 },
      { "ano": 2014, "valor": 25.12 },
      { "ano": 2015, "valor": 26.3 },
      { "ano": 2016, "valor": 25.74 },
      { "ano": 2017, "valor": 28.27 },
      { "ano": 2018, "valor": 27.49 },
      { "ano": 2019, "valor": 25.243 },
      { "ano": 2020, "valor": 34.955 },
      { "ano": 2021, "valor": 21.8 },
      { "ano": 2022, "valor": 18.9 },
      { "ano": 2023, "valor": 20.5 },
      { "ano": 2024, "valor": 18.2 },
  ...
  "produtividade_trabalho": {
    ...
    "cor": "#6366f1",
    "unidade": "USD internacionais PPC, preços constantes, por hora trabalhada",
  ...
  "transacoes_correntes_pib": {
    "label": "Transações Correntes (% do PIB)",
    "cor": "#0891b2",
    "unidade": "% do PIB",
  ...
  "carga_tributaria_pib": {
    "label": "Carga tributária bruta / PIB",
    "cor": "#4b5563",
    "unidade": "% do PIB",
  ...
  "infra_invest_pib": {
    "label": "Investimento em Infraestrutura (% do PIB)",
    "cor": "#0369a1",
    "unidade": "% do PIB",
  ...
  "fed_funds_aa": {
    "label": "EUA: Taxa de Juros (Fed Funds)",
    "cor": "#f43f5e",
    "unidade": "% a.a.",
  ...
  "us_payroll_avg": {
    "label": "EUA: Payroll (Média de Empregos/Mês)",
    "cor": "#8b5cf6",
    "unidade": "milhares",
  ...
  "tempo_trabalho_cesta_basica_dieese_sp": {
    ...
    "cor": "#9f1239",
    "unidade": "Horas decimais",
    "fonte": "DIEESE",
    "cat": "Impostos e Consumo",
    "descricao":
      "Mede a jornada média anual de trabalho necessária para que um trabalhador remunerado pelo salário mínimo compre a cesta básica média anual no município de São Paulo.",
    "como_interpretar":
      "Quanto maior o valor, menor o poder de compra do salário mínimo frente à cesta básica. Quedas indicam melhora relativa do poder de compra; altas indicam deterioração.",
    "metodologia":
      "O DIEESE calcula mensalmente o custo da Cesta Básica de Alimentos com base nas quantidades definidas pelo Decreto-Lei nº 399/1938. Para calcular o tempo de trabalho necessário, divide-se o salário mínimo vigente pela jornada mensal de 220 horas e aplica-se a fórmula: horas necessárias = custo da cesta x 220 / salário mínimo. A série aqui usa a média anual da cesta básica paulistana e a jornada média anual necessária divulgada pelo DIEESE.",
    "historico_metodologia":
      "A série histórica do município de São Paulo existe desde 1959. Em janeiro de 2016, o DIEESE atualizou a metodologia da Pesquisa Nacional da Cesta Básica de Alimentos, incluindo estrutura das cestas por região, locais de coleta, ponderação dos produtos por tipo de comércio, cadastro e amostra, tipos/marcas/unidades de medida, questionários e calendário de levantamento. Para 2015, o DIEESE informa que a série foi recalculada pela mudança metodológica; na série antiga, a jornada era 109h05, enquanto a série recalculada usada aqui é 109h19.",
    "abrangencia":
      "Município de São Paulo. Não é uma média nacional. O JSON original foi corrigido porque os valores oficiais consolidados desde 1994 disponíveis na fonte citada correspondem à série histórica de São Paulo.",
    "periodicidade": "Mensal, com consolidação anual pela média anual divulgada pelo DIEESE.",
    "eventos_externos": [
      {
        "ano": 1994,
        "nome": "Plano Real",
        "descricao":
          "A série mostra o maior valor do período validado, 225h10, no ano de implantação do Plano Real; o dado reflete o alto comprometimento do salário mínimo com a cesta básica média anual em São Paulo naquele ano.",
      },
      {
        "ano": 2006,
        "nome": "Valorização SM",
        "descricao":
          "A política de valorização do salário mínimo e reajustes reais contribuíram para forte queda da jornada média anual necessária, que passou de 137h43 em 2005 para 115h53 em 2006.",
      },
      {
        "ano": 2008,
        "nome": "Alta alimentos",
        "descricao":
          "A jornada subiu de 114h17 em 2007 para 126h54 em 2008, acompanhando aumento do custo da cesta básica frente ao salário mínimo.",
      },
      {
        "ano": 2020,
        "nome": "Choque alimentar",
        "descricao":
          "A jornada subiu de 108h09 em 2019 para 117h59 em 2020, em contexto de forte alta de alimentos durante a pandemia e perda relativa de poder de compra.",
      },
      {
        "ano": 2022,
        "nome": "Inflação alimentos",
        "descricao":
          "A jornada chegou a 138h36 em 2022, maior valor desde 1995 na série validada, com alta de itens como leite, pão, café, farinha de trigo, batata e outros alimentos.",
      },
      {
        "ano": 2024,
        "nome": "Reajuste SM",
        "descricao":
          "Apesar da alta da cesta em São Paulo, a jornada média anual caiu de 129h10 em 2023 para 127h14 em 2024, segundo o DIEESE, devido ao reajuste do salário mínimo no início de 2024.",
      },
    ],
    "comparacao_paises":
      "Não há comparação internacional direta confiável, pois a metodologia do DIEESE usa a cesta básica definida pelo Decreto-Lei nº 399/1938 e o salário mínimo brasileiro. Comparações com outros países exigiriam indicadores diferentes, como paridade de poder de compra, custo de alimentação ou salário mínimo real, sem equivalência metodológica direta.",
    "nivel_confiabilidade":
      "Alta para os valores de 1994 a 2024, pois foram extraídos da tabela histórica oficial do DIEESE para o município de São Paulo. Valores do JSON original que simulavam média nacional foram removidos por não corresponderem à série oficial consolidada apresentada pela fonte. O ano de 2025 não foi incluído porque a fonte pública consultada apresenta dados mensais/dezembro, mas não a média anual histórica consolidada equivalente à série usada.",
    "validacao": "GPT-5.5 Thinking (OpenAI) - 24/04/2026",
    "padrao": false,
    "fontes_links": [
      { "titulo": "DIEESE - Sistema de Consulta da Cesta Básica Nacional", "url": "https://www.dieese.org.br/cesta/" },
      {
        "titulo": "DIEESE - Metodologia da Pesquisa Nacional da Cesta Básica de Alimentos, janeiro de 2016",
        "url": "https://www.dieese.org.br/metodologia/metodologiaCestaBasica2016.pdf",
      },
      {
        "titulo": "DIEESE - Análise da Cesta Básica, dezembro de 2024",
        "url": "https://www.dieese.org.br/analisecestabasica/2024/202412cestabasica.pdf",
      },
      {
        "titulo": "DIEESE - Análise da Cesta Básica, dezembro de 2025",
        "url": "https://www.dieese.org.br/analisecestabasica/2025/202512cestabasica.pdf",
      },
    ],
    "dados": [
      { "ano": 1994, "valor": 225.17 },
      { "ano": 1995, "valor": 219.3 },
      { "ano": 1996, "valor": 193.77 },
      { "ano": 1997, "valor": 178.93 },
      { "ano": 1998, "valor": 180.37 },
      { "ano": 1999, "valor": 175.7 },
      { "ano": 2000, "valor": 172.63 },
      { "ano": 2001, "valor": 161.7 },
      { "ano": 2002, "valor": 155.17 },
      { "ano": 2003, "valor": 161.07 },
      { "ano": 2004, "valor": 149.8 },
      { "ano": 2005, "valor": 137.72 },
      { "ano": 2006, "valor": 115.88 },
      { "ano": 2007, "valor": 114.28 },
      { "ano": 2008, "valor": 126.9 },
      { "ano": 2009, "valor": 109.88 },
      { "ano": 2010, "valor": 106.93 },
      { "ano": 2011, "valor": 108.58 },
      { "ano": 2012, "valor": 103.58 },
      { "ano": 2013, "valor": 106.95 },
      { "ano": 2014, "valor": 105.35 },
      { "ano": 2015, "valor": 109.32 },
      { "ano": 2016, "valor": 114.2 },
      { "ano": 2017, "valor": 102.18 },
      { "ano": 2018, "valor": 102.83 },
      { "ano": 2019, "valor": 108.15 },
      { "ano": 2020, "valor": 117.98 },
      { "ano": 2021, "valor": 131.57 },
      { "ano": 2022, "valor": 138.6 },
      { "ano": 2023, "valor": 129.17 },
      { "ano": 2024, "valor": 127.23 },
    ],
  },
  "indice_big_mac_usd": {
    "label": "Índice Big Mac (Preço em USD)",
    "cor": "#fbbf24",
    "unidade": "USD",
    "fonte": "The Economist",
    "cat": "Impostos e Consumo",
  ...
  "idea_gsod_representacao_br": {
    "label": "Representação (International IDEA)",
    "unidade": "Índice (0-1)",
  ...
  "idea_gsod_direitos_fundamentais_br": {
    "label": "Direitos (International IDEA)",
    "unidade": "Índice (0-1)",
  ...
  "international_idea_rule_of_law_br": {
    "label": "Estado de Direito (International IDEA)",
    "unidade": "Índice (0-1)",
    "fonte": "International IDEA - Global State of Democracy Indices",
    "cat": "Institucional",
    "descricao":
  ...
  "participation_br": {
    "label": "Participação (International IDEA)",
    "unidade": "Índice (0-1)",
    "fonte": "International IDEA - Global State of Democracy Indices",
    "cat": "Institucional",
  ...
  "international_idea_checks_on_government_br": {
    "label": "Checks on Government (International IDEA)",
    "unidade": "Índice (0-1)",
  ...
  "international_idea_administracao_imparcial_br": {
    "label": "Administração Imparcial (International IDEA)",
    "unidade": "Índice (0-1)",
    "fonte": "International IDEA - Global State of Democracy Indices",
    "cat": "Institucional",
  ...
  "democracia_freedom_house_br": {
    "label": "Freedom in the World (Freedom House)",
    "cor": "#0ea5e9",
  ...
  "nep_legislativo": {
    "label": "Número Efetivo de Partidos (NEP)",
    "cor": "#8b5cf6",
    "unidade": "Partidos",
    "fonte": "TSE / Jairo Nicolau / V-Dem / Câmara dos Deputados",
    "cat": "Política",
    "descricao":
      "O NEP (índice Laakso-Taagepera) mede a fragmentação partidária no Legislativo, ponderando o número de partidos pelo seu peso eleitoral/cadeiras. A série histórica brasileira revela um crescimento explosivo da fragmentação, atingindo o pico mundial em 2018. O recuo em 2022 e as projeções para 2026 refletem a eficácia da cláusula de desempenho e a criação das federações partidárias, forçando uma consolidação do sistema.",
    "dados": [
      { "ano": 1994, "valor": 8.2 },
      { "ano": 1995, "valor": 8.1 },
      { "ano": 1996, "valor": 8.1 },
  ...
  "taxa_sucesso_legislativo": {
    "label": "Taxa de Sucesso Legislativo (Executivo)",
    "cor": "#4f46e5",
    "unidade": "% de aprovação",
    "fonte": "Câmara dos Deputados / CNN Brasil / Argelina Figueiredo & Fernando Limongi",
    "cat": "Política",
    "descricao":
      "Mede o percentual de projetos de lei de iniciativa do Poder Executivo (Presidente) que são efetivamente aprovados pelo Congresso Nacional. Esta métrica é o principal termômetro do 'Presidencialismo de Coalizão' e da governabilidade. A série histórica revela uma mudança estrutural profunda: após uma era de alta dominância do Executivo nos governos Lula 1 e 2 (com taxas acima de 60%), o país entrou em uma fase de 'Empoderamento do Legislativo'. O evento mais marcante recente foi a queda para 27% em 2023, o menor patamar desde a era FHC. Como destaca a Vector Research, 'Lula tem a menor taxa de projetos aprovados desde FHC', refletindo um Congresso mais proativo e menos dependente da agenda do Planalto. A projeção para 2024-2026 indica uma estabilização em patamares baixos (~30%), consolidando um modelo onde o Executivo precisa negociar exaustivamente cada ponto da pauta em um ambiente de fragmentação partidária e controle parlamentar sobre o orçamento.",
    "dados": [
      { "ano": 1994, "valor": 78.2 },
      { "ano": 1995, "valor": 34.0 },
      { "ano": 1996, "valor": 35.5 },
  ...
  "custo_coalizao_emendas": {
    "label": "Custo de Coalizão (Emendas Parlamentares)",
    "cor": "#f59e0b",
    "unidade": "Bilhões de R$",
    "fonte": "Portal da Transparência / Tesouro Nacional / FGV IBRE",
    "cat": "Política",
    "descricao":
      "Mede o volume total de recursos do Orçamento da União direcionados por emendas parlamentares (individuais, de bancada, de comissão e as extintas de relator/RP9). Este indicador é utilizado como proxy para o 'custo de governabilidade', refletindo o poder de barganha do Congresso sobre o Executivo. A série histórica revela uma mudança de paradigma: de valores residuais e discricionários nos anos 90, para um modelo 'impositivo' e inflado a partir de 2014. O salto exponencial entre 2020 e 2024 marca a era do 'Orçamento Secreto' e o posterior empoderamento das comissões, fazendo com que o Legislativo passasse a controlar quase metade das transferências federais discricionárias, reduzindo a capacidade de planejamento estratégico do governo federal.",
    "dados": [
      { "ano": 1994, "valor": 0.45 },
      { "ano": 1995, "valor": 0.58 },
      { "ano": 1996, "valor": 0.62 },
      ...
      { "ano": 2018, "valor": 15.2 },
      { "ano": 2019, "valor": 16.8 },
      { "ano": 2020, "valor": 37.54 },
      { "ano": 2021, "valor": 33.4 },
      { "ano": 2022, "valor": 25.45 },
      { "ano": 2023, "valor": 35.37 },
      { "ano": 2024, "valor": 44.81 },
      { "ano": 2025, "valor": 50.3 },
      { "ano": 2026, "valor": 61.0 },
    ],
    "padrao": false,
  },
  "dominancia_executiva_mp": {
    "label": "Dominância do Executivo (Medidas Provisórias)",
    "cor": "#6d28d9",
    "unidade": "MPs editadas / ano",
    "fonte": "Planalto / Câmara dos Deputados / Figueiredo & Limongi",
    "cat": "Política",
    "descricao":
      "Mede a quantidade anual de Medidas Provisórias (MPs) editadas pelo Presidente da República. Este é o principal indicador do 'poder de agenda' do Executivo no Brasil. Historicamente, as MPs permitem que o governo legisle com efeito imediato, trancando a pauta do Congresso se não forem votadas. A série mostra dois momentos críticos: o período pré-2001 (marcado por reedições ilimitadas) e o período pós-EC 32/2001, que racionalizou o instrumento. O recorde histórico ocorreu em 2020, quando o governo editou 101 MPs para enfrentar a crise da COVID-19. Como destaca a Revista Oeste, 'o Congresso tem demonstrado maior resistência ultimamente, com taxas de conversão em lei atingindo mínimas históricas em 2023 e 2024', sinalizando um deslocamento do poder decisório em direção ao Legislativo e uma crise no modelo tradicional de dominância por decreto.",
    "dados": [
      { "ano": 1994, "valor": 55 },
      { "ano": 1995, "valor": 60 },
      { "ano": 1996, "valor": 64 },
  ...
  "indice_friccao_institucional": {
    "label": "Índice de Fricção Institucional",
    "cor": "#4b5563",
    "unidade": "Índice (0-10)",
    "fonte": "JOTA / FGV / Eurasia Group / V-Dem",
    "cat": "Política",
    "descricao":
      "Mede o nível de conflito e dificuldade na coordenação entre os Poderes Executivo, Legislativo e Judiciário. Um índice elevado (próximo de 10) indica paralisia institucional, elevada judicialização da política e custos proibitivos para a governabilidade. A série histórica revela que a fricção atingiu o seu pico em 2016 (processo de impeachment) e manteve-se elevada entre 2019 e 2022 devido a crises entre o Planalto e o STF. Atualmente, a fricção deslocou-se para a disputa pelo controlo do Orçamento e da autonomia de órgãos reguladores. Conforme a análise do JOTA, 'o aumento da fricção institucional é um sintoma da transição para um modelo onde o Congresso dita o ritmo das reformas, desafiando a proeminência histórica do Executivo'. A projeção para 2024-2026 aponta para uma estabilização num patamar moderado-alto, refletindo um equilíbrio de forças tenso, mas funcional, entre as instituições.",
    "dados": [
      { "ano": 1994, "valor": 4.5 },
      { "ano": 1995, "valor": 3.8 },
      { "ano": 1996, "valor": 3.6 },
  ...
  "saldo_aprovacao_governo": {
    "label": "Saldo de Aprovação do Governo (Net Approval)",
    "cor": "#475569",
    "unidade": "p.p. (% Ótimo/Bom - % Ruim/Péssimo)",
    "fonte": "Datafolha / IPEC (antigo IBOPE) / PoderData / CNT",
    "cat": "Política",
    "descricao":
      "Mede o saldo líquido de popularidade da gestão presidencial federal, calculado pela diferença entre o percentual de aprovação (Ótimo/Bom) e o de desaprovação (Ruim/Péssimo). Este indicador é o principal preditor de governabilidade e sucesso eleitoral. A série histórica ilustra os extremos da democracia brasileira: o auge da popularidade de Lula em 2010 (+75), impulsionado pelo crescimento económico; o colapso de Dilma Rousseff após os protestos de 2013 e a crise de 2015; e o recorde histórico negativo de Michel Temer (-79). Atualmente, a métrica reflete o fenômeno da polarização estrutural, onde o saldo tende a oscilar próximo da neutralidade, com uma base de apoio e uma oposição cristalizadas, tornando mais difícil para os presidentes atingirem os níveis de consenso observados na década de 2000.",
    "dados": [
      { "ano": 1994, "valor": 26 },
      { "ano": 1995, "valor": 23 },
      { "ano": 1996, "valor": 12 },
  ...
  "indice_confianca_governante": {
    "label": "Índice de Confiança no Governante",
    "cor": "#10b981",
    "unidade": "% que confiam",
    "fonte": "CNI-IBOPE / IPEC / Datafolha / PoderData",
    "cat": "Política",
    "descricao":
      "Mede o percentual da população que afirma confiar na figura do Presidente da República, independentemente da avaliação da gestão. Enquanto a aprovação mede o 'fazer', a confiança mede a 'credibilidade' pessoal do mandatário. A série histórica mostra que este índice é altamente sensível a escândalos éticos e crises econômicas. O auge foi registrado em 2010, quando a confiança em Lula atingiu níveis recordes, refletindo a sensação de ascensão social. O declínio acentuado em 2015 e o piso histórico de 2017 (governo Temer) evidenciaram a crise de representatividade do sistema político. Atualmente, o índice encontra-se 'estacionado' em um patamar de polarização: a confiança é alta entre apoiadores e nula entre opositores, com pouca oscilação no centro, o que sugere uma cristalização das percepções sobre a liderança nacional.",
    "dados": [
      { "ano": 1994, "valor": 52 },
      { "ano": 1995, "valor": 58 },
      { "ano": 1996, "valor": 54 },
  ...
  "ipd_popularidade_digital": {
    "label": "Índice de Popularidade Digital (IPD)",
    "cor": "#f97316",
    "unidade": "Índice (0-100)",
    "fonte": "Quaest Consultoria / Felipe Nunes",
    "cat": "Política",
    "descricao":
      "Mede o desempenho e a relevância de figuras políticas nas principais redes sociais (Instagram, X, Facebook, YouTube, TikTok e Google Search). O IPD é calculado através de um algoritmo que processa 152 variáveis estruturadas em seis dimensões: Presença, Influência, Engajamento, Alcance, Sentimento e Vitalidade. Criado pela Quaest, o índice tornou-se a métrica padrão para entender a força política no ambiente digital brasileiro, onde a popularidade não é apenas sobre o número de seguidores, mas sobre a capacidade de mobilização e a predominância de menções positivas. A série histórica mostra o surgimento desta métrica em 2018, capturando a ascensão da 'nova direita' e, posteriormente, a tentativa de reequilíbrio da esquerda no campo digital. As projeções para 2026 refletem o aquecimento das redes para o ciclo eleitoral, onde o IPD atua como um termômetro em tempo real do potencial de votos.",
    "dados": [
      { "ano": 1994, "valor": 0 },
      { "ano": 1995, "valor": 0 },
      { "ano": 1996, "valor": 0 },
  ...
  "indice_rejeicao_presidencial": {
    "label": "Índice de Rejeição Presidencial",
    "cor": "#dc2626",
    "unidade": "% que não votariam de jeito nenhum",
    "fonte": "Datafolha / IPEC / PoderData / CNT",
    "cat": "Política",
    "descricao":
      "Mede o percentual da população que afirma que não votaria 'de jeito nenhum' no atual mandatário em uma eventual eleição. Este índice é considerado o 'teto de vidro' de um político; quanto maior a rejeição, menor a capacidade de atrair o eleitorado de centro e vencer em segundos turnos. A série histórica destaca o fenômeno da 'rejeição estrutural' pós-2013: se antes era possível governar com rejeições abaixo de 20% (como Lula em 2010), o cenário atual de polarização consolidou um patamar onde quase metade do eleitorado rejeita o governante por princípio ideológico. O recorde histórico de rejeição pertence a Michel Temer, refletindo o colapso do sistema político tradicional durante a crise de 2017.",
    "dados": [
      { "ano": 1994, "valor": 22 },
      { "ano": 1995, "valor": 18 },
      { "ano": 1996, "valor": 21 },
  ...
  "indice_desempenho_economico_percebido": {
    "label": "Índice de Desempenho Econômico Percebido",
    "cor": "#0891b2",
    "unidade": "Saldo de Percepção (p.p.)",
    "fonte": "Datafolha / IPEC / CNI (INEC) / FGV",
    "cat": "Política",
    "descricao":
      "Mede o saldo líquido entre o percentual da população que percebe que a economia brasileira 'melhorou' versus os que percebem que 'piorou' nos últimos meses. Este índice funciona como um termômetro subjetivo da economia real, sendo altamente influenciado pela inflação de alimentos, taxa de desemprego e poder de compra. A série histórica reflete os ciclos de euforia do Plano Real (1994) e do boom das commodities (2010), contrastando com os abismos de percepção negativa durante a crise cambial de 1999, a recessão de 2015-2016 e o impacto inflacionário pós-pandemia. Conforme o Datafolha, 'a percepção econômica é o principal lastro da popularidade presidencial', com o saldo retornando a patamares negativos no início de 2026 devido à resiliência da inflação de serviços e incertezas fiscais.",
    "dados": [
      { "ano": 1994, "valor": 32 },
      { "ano": 1995, "valor": 28 },
      { "ano": 1996, "valor": 15 },
  ...
  "comparacao_antecessor_melhor": {
    "label": "Comparação com Antecessor (Melhor)",
    "cor": "#6366f1",
    "unidade": "% considera 'Melhor'",
    "fonte": "Datafolha / IPEC / PoderData / CNT",
    "cat": "Política",
    "descricao":
      "Mede o percentual da população que considera o governo atual 'melhor' do que o de seu antecessor imediato. A série histórica reflete as grandes rupturas da Nova República. Segundo o Datafolha, em março de 2024, '43% dos brasileiros consideravam o governo Lula melhor que o de Bolsonaro, enquanto 34% o consideravam pior'. As projeções para 2025-2026 sugerem uma estabilização na casa dos 40%, indicando que a percepção de melhora comparativa encontrou um teto ditado pela divisão ideológica do país.",
    "dados": [
      { "ano": 1994, "valor": 35 },
      { "ano": 1995, "valor": 41 },
      { "ano": 1996, "valor": 38 },
  ...
  "threshold_aprovacao_reeleicao": {
    "label": "Threshold de Reeleição (Aprovação Ótimo/Bom)",
    "cor": "#16a34a",
    "unidade": "% Ótimo/Bom",
    "fonte": "Datafolha / IPEC / Alberto Carlos Almeida (O Voto do Brasileiro)",
    "cat": "Política",
    "descricao":
      "Mede o percentual de aprovação (Ótimo/Bom) do presidente em exercício, métrica utilizada como o principal indicador de viabilidade para a reeleição. Segundo o cientista político Alberto Carlos Almeida em 'O Voto do Brasileiro', o patamar de **40% de Ótimo/Bom** é o 'limiar de segurança' (threshold) histórico: governantes acima deste índice possuem alta probabilidade de vitória, enquanto aqueles abaixo de 30% enfrentam rejeição quase intransponível. A série destaca que FHC (1998), Lula (2006) e Dilma (2014) garantiram a renovação do mandato ao atingirem ou superarem esse patamar no ano eleitoral, enquanto Bolsonaro (2022) foi o primeiro presidente a perder uma tentativa de reeleição ao permanecer marginalmente abaixo do threshold necessário em um ambiente de alta polarização [1][2]. Para 2026, as projeções indicam que o governo busca estabilizar o índice acima dos 38% para garantir competitividade na sucessão presidencial.",
    "dados": [
      { "ano": 1994, "valor": 43 },
      { "ano": 1995, "valor": 41 },
      { "ano": 1996, "valor": 30 },
  ...
  "indice_miseria_eleitoral": {
    "label": "Índice de Miséria Eleitoral (Okun Index)",
    "cor": "#b91c1c",
    "unidade": "Soma simples (IPCA + Desemprego)",
    "fonte": "IBGE / Banco Central do Brasil / Arthur Okun",
    "cat": "Política",
    "descricao":
      "Calculado pela soma da taxa de inflação anual (IPCA) com a taxa de desemprego (PNAD), o Índice de Miséria é um dos preditores mais precisos do comportamento do eleitorado. Criado pelo economista Arthur Okun, o índice parte da premissa de que o custo de vida e a falta de postos de trabalho são os principais vetores de insatisfação social. No Brasil, a série histórica demonstra que governos com índice acima de 20 pontos enfrentam crises de legitimidade severas (como em 2015-2016 e 2021), enquanto o patamar de 'bem-estar eleitoral' situa-se abaixo de 13 pontos. Segundo analistas, 'a miséria econômica é o veneno das reeleições; quando o índice sobe, a rejeição ao incumbente tende a acompanhar de forma quase linear' [1]. Para 2026, as projeções indicam uma leve pressão de alta devido à resiliência do desemprego estrutural e à convergência lenta da inflação para a meta.",
    "dados": [
      { "ano": 1995, "valor": 28.2 },
      { "ano": 1996, "valor": 16.5 },
      { "ano": 1997, "valor": 13.0 },
  ...
  "incumbency_advantage_premium": {
    "label": "Prêmio de Vantagem do Incumbente",
    "cor": "#1e40af",
    "unidade": "% Estimado de Votos / Probabilidade",
    "fonte": "TSE / CEPESP Data (FGV) / Jairo Nicolau / George Avelino",
    "cat": "Política",
    "descricao":
      "Mede o 'prêmio' estatístico em votos ou na probabilidade de vitória que um ocupante de cargo (incumbente) possui sobre seus desafiantes. No Brasil, essa vantagem é estruturada pelo controle da máquina pública, visibilidade mediática institucional e, principalmente, pela gestão do orçamento discricionário (emendas). A série histórica inicia-se em zero até a aprovação da Emenda da Reeleição em 1997. Segundo o cientista político Jairo Nicolau, 'o sistema brasileiro é desenhado para favorecer quem detém a caneta, transformando a reeleição na norma de sobrevivência política'. O indicador registrou queda abrupta em 2018 (onda anti-establishment), mas recuperou força nas eleições municipais de 2024, onde as taxas de reeleição bateram recordes. Para 2026, a projeção de 14,5% reflete o impacto do controle orçamentário sem precedentes e o uso de redes sociais institucionais como combustível para a continuidade do poder.",
    "dados": [
      { "ano": 1994, "valor": 0.0 },
      { "ano": 1995, "valor": 0.0 },
      { "ano": 1996, "valor": 0.0 },
  ...
  "polarizacao_afetiva_br": {
    "label": "Índice de Polarização Afetiva",
    "cor": "#ef4444",
    "unidade": "Índice (0-100)",
    "fonte": "V-Dem Institute / ESEB (Unicamp)",
    "cat": "Social",
    "descricao":
      "Antagonismo irracional entre blocos políticos. O salto para >90 capta a divisão radical pós-2013 e a ascensão das redes sociais. A polarização no Brasil atingiu níveis de paralisia superiores à maior parte da Europa.",
    "dados": [
      { "ano": 1994, "valor": 32.4 },
      { "ano": 1995, "valor": 33.1 },
      { "ano": 1996, "valor": 31.8 },
